...
func GetCourseGalleriesTable(ctx *context.Context) table.Table {
	...
	courseGalleries := table.NewDefaultTable(table.Config{
	...
	info := courseGalleries.GetInfo()

	info.SetTable("course_galleries").SetTitle("CourseGalleries").SetDescription("CourseGalleries")
	...
	formList.SetTable("course_galleries").SetTitle("CourseGalleries").SetDescription("CourseGalleries")
